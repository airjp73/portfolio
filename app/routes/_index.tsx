  ...
  return (
    <>
      <div className="fixed top-4 right-4 flex space-x-4">
        <a href="#main" className="fixed -top-20 focus:static bg-white p-1">
          Skip to main content
        </a>
        <a
          href="https://www.github.com/airjp73"
          aria-label="GitHub"
          className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-600 rounded-full"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 496 512"
            aria-hidden
            className="h-8 w-8 fill-[#333]"
          >
        ...
        <a
          href="https://www.linkedin.com/in/aaron-pettengill-7706846b/"
          aria-label="LinkedIn"
          className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-sky-600 rounded-sm"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 448 512"
